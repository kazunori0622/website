      ...
      <div class="container">
          ...
          <div class="loginErrMsg">
            ...
            <h3>レビュー更新</h3>
              ...
              <form action="ReviewUpdateServlet?id=${review.id}&rMoveId=${review.rMoveId}" method="post">
              <div class="row border-bottom">
                  <div class="col-4">
                    <p>作品名のレビューを更新する</p>
                    ...
                    <h6>採点する</h6>
                          ...
                          <% for (int i = 5; i >= 1; i--) {
                        	ReviewBeans rb = (ReviewBeans)request.getAttribute("review");

	                          if(rb.getReviewScore() == i) {
	                          %>
	                              <input id="star<%=i %>" type="radio" name="star" value="<%=i %>" checked="checked"/>
	                              <label for="star<%=i %>"><span class="text"><%=i %></span>★</label>
	                         <%
	                          } else {
	                          %>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-7">
                    ...
                    <input type="text" name="reviewName" class="form-control" placeholder="レビュータイトル" id="reviewName" value="${review.reviewName}">
                  </div>
              </div>

              <div class="form-group row">
                  <label class="col-2 col-form-label" for="reviewText">本文</label>
                  <div class="col-7">
                      <textarea rows="10" name="reviewContent" class="form-control" placeholder="本文" id="reviewText">${review.reviewContent}</textarea>
                  </div>
              </div>
